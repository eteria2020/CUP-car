...
Car.prototype.getWhitelist = function getWitelist() {
    ...
    //console.log(msg);
    axios.get(hostNode + 'whitelist2').then(function (response) {
        //console.log(response);
...
Car.prototype.getBusiness = function getWitelist() {
    ...
    //console.log(msg);
    axios.get(hostNode + 'business-employees').then(function (response) {
        //console.log(response);
    ...
    if (!this.trip) {
        ...
        axios.post(hostNode + 'trips', {
            ...
            if (response.data.data.result > 0) {
                _this.tripResponse = response.data.data.result;
            } else {
                _this.tripResponse = response.data.data.extra;
            }
        }).catch(function (error) {
            console.log(error);
        });
...
Car.prototype.sendEvents = function getWitelist() {
    ...
    //console.log(msg);
    axios.post(hostNode + "events", Utility.generateRandomEvents(this)).then(function (response) {
        console.log(response.data);
